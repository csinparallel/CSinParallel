...
/**
  ...
  December 2021 Libby Shoop added change so gnuplot messages go to
                /dev/null for unix. Might not be to everyone's taste. 
*/
/*--------------------------------------------------------------------------*/
...
#define GNUPLOT_EXEC_NO_STDOUT "gnuplot >/dev/null"
#define GNUPLOT_EXEC_NO_STDERR "gnuplot >/dev/null 2>&1"
#else
